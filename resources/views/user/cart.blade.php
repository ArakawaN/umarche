                ...
                <div class="p-2 text-gray-900">
                    ...
                    @foreach ($products as $product)
                        ...
                        items-center justify-center mb-8" >
                            ...
                            <div class="">{{$product->pivot->quantity}}個</div>
                            <div class="">{{number_format($product->pivot->quantity * $product->price)}}<span class="text-sm text-grey-700 ">円(税込)</span>
                            </div>
    
                            <div class="md:w-2/12 ml-8 ">
                    ...
                    <div class="my-2">
                        小計:{{number_format($totalPrice)}}<span class="text-sm text-grey-700">円(税込)</span>
                    </div>
                    <div class="">
