                        ...
                        <div class="container md:px-5 mx-auto">
                           ...
                           <x-flash-message status="session('status')" />
                            ...
                            <div class="flex justify-end mb-4" >
                                <button onclick="location.href='{{route('admin.owners.create')}}'" class="text-white bg-indigo-400 border-0   py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">新規登録</button>    
                            </div>
                            
                          <div class="lg:w-2/3 w-full mx-auto overflow-auto">
                            <table class="table-auto mb-4 w-full text-left whitespace-no-wrap">
                              <thead>
                                <tr>
                                  ...
                                  <th class="md:px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100 rounded-tr rounded-br text-center ">編集</th>
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td class="md:px-4 py-3 text-center ">
                                    <button onclick="location.href='{{route('admin.owners.edit',['owner'=> $owner->id ])}}'" class="text-white bg-blue-400 border-0  py-2 px-6 focus:outline-none hover:bg-blue-500 rounded ">編集する</button>
                                  </td>
                                  <form id="delete_{{$owner->id}}" action="{{route('admin.owners.destroy',['owner'=>$owner->id])}}" method="POST" >
                                    @csrf
                                    @method('delete')
                                  <td class="md:px-4 py-3 text-center ">
                                    <a data-id="{{$owner->id}}" href="#" onclick="deletePost(this)" class="text-white bg-red-400 border-0  py-2 px-6 focus:outline-none hover:bg-red-500 rounded ">削除する</a>
                                  </td>
                                </form>
                                </tr>
                              </tbody>
